---
title: "Re-Lend"
description: "Earn additional yields on your existing lending positions on Aave by delegating borrowing power to 246 Club."
---
...
Read more about how these markets are structured and how the interest model works in the Architecture section.

#### 3) Where Additional Yield Comes From

The extra yield comes from the borrowers on 246 Club who use your delegated borrowing power to take out loans—sometimes against collaterals that Aave doesn’t support. They pay a premium on top of the Aave borrowing rate. This premium goes back to you, the re-lender.
...
> Source: [Re-Lend (Supply) — Quickstart](https://246-club.gitbook.io/docs/re-lend-supply/quickstart)
